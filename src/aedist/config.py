...
# documentation flags/counts (Gold, GEM, Wikipedia, model census). The
# long-tail recognition figure reads THIS CSV; caption counts are re-derived
# from it (derive-prose-from-artifacts rule). Single source of truth.
LONGTAIL_LAYERS_CSV = (
