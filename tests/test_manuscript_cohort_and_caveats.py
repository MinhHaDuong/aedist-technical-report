...
import pytest
from manuscript_source import body, figure_caption
...
def test_rho_caveat_in_abstract_and_conclusion():
    ...
    text = body()
    # Ticket 0518/0524: the "Annex F" reference is the symbolic \ref{sec:annex-screen}.
    caveat = "within-model signal positive but modest, \\ref{sec:annex-screen}"
    # Abstract region: everything before the Introduction section.
    abstract = text.split("\\section{Introduction}\\label{sec:intro}")[0]
