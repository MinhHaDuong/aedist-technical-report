...
\begin{description}
\item[Agrégation multi-runs] (\emph{self-consistency}) Combinaison des résultats de plusieurs exécutions d'un même modèle, par \emph{vote majoritaire} ou par \emph{union}.
