...
% TODO(0254 — Blocked-by 0383: post-re-baseline numbers)
...
le tableau de difficulté par statut (en préparation). Le panneau de gauche
...
obscures des colonnes clairsemées. Le tableau de difficulté par statut, qui
partage la même dérivation des données, prendra place dans cette annexe.
