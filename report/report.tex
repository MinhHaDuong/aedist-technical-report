...
\caption{Expérience~2 (frontière SOTA)~: F1 par ligne, couverture et coût par exécution, regroupés par agent. Les barres distinguent les deux bras enregistrés (sans documents) des deux conditions exploratoires (avec documents). Quatre agents, 5~répétitions par cellule.}
