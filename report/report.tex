...
\begin{figure}[h]
\centering
\includegraphics[width=0.85\linewidth]{inputs/generated/fig_census_direct.pdf}
\caption{Résultats des \NumCensusModels{} modèles sur le prompt census (passe unique, sans documentation). Chaque barre~: un run, une couleur par modèle. Ligne verte~: référence (163 centrales).}
\label{fig:census-direct}
\end{figure}
...
\InputIfFileExists{inputs/generated/tab_exp2_arms}{}{}

\IfFileExists{inputs/generated/fig_quality_spider.pdf}{
\begin{figure}[h]
\centering
\includegraphics[width=0.78\linewidth]{inputs/generated/fig_quality_spider.pdf}
\caption{Profils de qualite sur huit axes en vocabulaire non specialistes pour les bras naive et optimise de l'experience 2.}
\label{fig:exp2-quality-spider}
\end{figure}
}{}
...
Le rapport qualité-coût varie sur deux ordres de grandeur~: Claude~Opus (0,79\,\$, 491\,s, 61~centrales) contre DeepSeek~V3.2 (0,004\,\$, 281\,s, 49~centrales). Le prompt direct complet sert de condition de contrôle externe dans l'expérience d'ablation (section~\ref{sec:exp3}).
