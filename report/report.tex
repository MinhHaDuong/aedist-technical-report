...
Gemini~2.5~Flash~Lite présente le régime inverse~: 100\,\% de rappel dans les 3 runs (\NumRefPlants{}/\NumRefPlants{} centrales thermiques trouvées), mais il ajoute un nombre variable de centrales non thermiques (hydroélectriques, éoliennes, nucléaires)~--- de 11 dans le meilleur cas à 480 dans le pire.
...
La décomposition élimine la troncature~: 12 des 14 runs complétés atteignent 100\,\% de rappel (\NumRefPlants{}/\NumRefPlants{} centrales), contre un maximum de 144 en requête unique. L'effet net sur le F1 dépend du modèle~: fortement positif pour les modèles qui étaient limités par la troncature (DeepSeek~: +33,6 points, Mistral~Large~: +22,6 points), mais négatif pour GPT-5.4 qui était déjà performant en requête unique.
