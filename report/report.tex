...
\centering
\includegraphics[width=\textwidth,height=0.88\textheight,keepaspectratio]{inputs/generated/fig_exp1_recognition_matrix_fr.pdf}
...
\ExpOneMatrixRuns{}~runs (lignes, une étiquette par modèle, 5~répétitions
chacune). Bleu~= centrale reconnue~; panneau de gauche~:
