...
% --- Para 1: accuracy proved, cost eliminated ---
Les résultats de ce rapport montrent qu'un pipeline RAG avec décomposition des requêtes récupère déjà 99\,\% d'un inventaire expert, pour un coût marginal de 0,06\,\$. Le design de la méthode -- régime documentaire, décomposition, agrégation -- explique davantage de variance que le choix du modèle~: un modèle open-weight à 0,26\,\$/Mtok surpasse des modèles propriétaires dix fois plus coûteux. La précision est acquise~; la barrière du coût est levée.
...
% --- Para 3: from thermal to full power system (Level 4 — scope) ---
