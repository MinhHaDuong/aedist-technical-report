...
Les LLM seuls retournent 30 à 40 centrales sur plus de 110 recensées~; l'approche RAG avec relances atteint 73 correspondances (exactes et approximatives) sur l'inventaire de référence. Les graphes globaux apportent des données complémentaires mais aucun n'est suffisant seul. Les outils intégrés (R2R, TrustGraph) combinant agents, RAG et graphes de connaissances restent immatures.

Ces résultats montrent qu'une approche hybride -- combinant RAG, graphes de connaissances alignés sur une ontologie du domaine, et agents spécialisés -- est nécessaire et faisable pour produire des statistiques énergétiques traçables à partir de sources hétérogènes et multilingues.
\end{abstract}
