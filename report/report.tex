...
\caption{Résultats des \NumModelsTested{} modèles sur le prompt census (passe unique, sans documentation). Chaque barre~: un run, une couleur par modèle. Ligne verte~: référence (163 centrales).}
