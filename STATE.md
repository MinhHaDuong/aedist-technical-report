...
Pipeline end-to-end via Makefile. Census done (35 models, F1 2–66%, $0.82). 380 tests pass. Sweep 2 RAG + multiturn + web complete. Reporting refactored to read from measurements.jsonl (130 RunRecords, ticket 0003 closed, PR #157). Decomposition experiment: DeepSeek V3.2 163/163 plants, F1=98.8%, $0.06. Self-consistency analysis merged (#96). Worker infrastructure operational. Gold truth corpus: 18 manually verified tables (155 KB).
...
6. Retire all_metrics.json paths (ticket 0004)
...
- [x] Reporting reads from measurements.jsonl (ticket 0003, PR #157)
...
- Retire all_metrics.json and per-sweep summary paths (ticket 0004)
