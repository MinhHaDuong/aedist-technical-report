...
4. **Update slides.** DONE — conference delivered 2026-05-27. `slides-en.tex` created;
   EN is now source of truth, FR is translated (script: ticket 0363).
...
- Slides EN→FR translation script (0363): `slides-en.tex` is source of truth; script calls `claude` CLI to regen `slides.tex`, guarded by anteriority + FR-committed-clean checks.
