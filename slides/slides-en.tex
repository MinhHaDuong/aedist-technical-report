...
\date{Revised post-conference version --- presented at Econom'IA 2026, Thema, Cergy, May 27, 2026}
...
\smallskip
\textbf{Primary metric:} number of assets correctly identified in the \NumRefPlants reference list.
...
% -------------------------------------------------------------------
\begin{frame}{The method --- Simple-harness condition (arms 2 \& 4)}
...
\smallskip
{\small\textit{Simple harness = orchestrator (DeepSeek classifier) + loop + tool (tested LLM). ``Simple'' because the prompts are fixed, not generated adaptively.}}
...
% NOTE: tab_exp2_2x2_fr.tex is the FR table (tabulate_exp2_2x2 --lang fr); regenerate with --lang en for an English render.
