...
\begin{enumerate}
  ...
  \item \textbf{Filter} references --- human validates\\
        which sources are real and accessible
  \item \textbf{Crawl} validated sources, get PDFs,\\
...
\medskip
The corpus is the lasting asset ---
it answers questions beyond
the original table.

\medskip
Research-quality data isn't data
that's correct. It's data that's
\textbf{correctable}: when a reviewer
finds an error, the pipeline tells
you which source was wrong.
\end{columns}
\end{frame}
