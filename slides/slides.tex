...
\vspace{-0.3em}
{\small \textbf{5 models} $\times$ \textbf{5 methods} $\times$ 3 runs.
Each dot = 1 plant.
...
\vspace{-0.3em}
\begin{center}
\includegraphics[width=\textwidth, trim=0 0 0 0, clip]{inputs/generated/fig_method_convergence.pdf}
\end{center}

\vspace{-1em}
{\small \textbf{Decomposed} finds all 163 but hallucinates.
