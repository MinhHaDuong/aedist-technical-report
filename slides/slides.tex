...
\begin{columns}[T]
\column{0.55\textwidth}
\textbf{Before we can trust AI-produced datasets:}

\medskip
\begin{tabular}{@{}lp{4.2cm}@{}}
\toprule
\textbf{Pilot gap} & \textbf{What's needed} \\
\midrule
1 task, 1 country     & Validate on 4+ countries
                        and sectors \\[3pt]
Memorization risk     & Adversarial controls ---
                        synthetic references unseen
                        in training \\[3pt]
Axes tested separately & Compose: knowledge $\times$
                        conversation $\times$ decomposition
...
\begin{enumerate}
  ...
  \item Cost is negligible: \$0.06 per dataset,
        \$0.82 for the full 37-model sweep
