...
\textbf{Expérimentation \NumModelsTested{} modèles, 3 runs chacun~:}  % TODO: Vérifier que c'est bien \NumModelsTested{} modèles
``{\ttfamily \input{../experiments/prompts/prompt_extract.txt}}''

\smallskip
\textbf{Résultats (163 centrales à identifier)~:}
\begin{itemize}\setlength\itemsep{0pt}
  \item Centrales identifiées~:  %Add a macro for the range of TP distribution across runs
  \item Centrales hallucinées~: %Add a macro for the range of FP distribution across runs
  \item Durée~: %Add a macro for the total time range across runs
  \item Coût~: %Add a macro for the total cost range across runs
\end{itemize}
...
\begin{frame}[plain]
\centering
\includegraphics[height=\paperheight,keepaspectratio]{inputs/generated/fig_census_direct.pdf}
