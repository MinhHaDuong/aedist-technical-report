...
% -------------------------------------------------------------------
\begin{frame}{The obvious approach works}
\begin{columns}[T]
...
\medskip
\textbf{You get:} a CSV table of ${\sim}$120 plants in 30 seconds, for \$0.02.
Names, fuels, capacities, provinces --- mostly correct.

\medskip
A frontier model with documents (RAG) recovers \textbf{161 out of 163}
plants. F1 = 98.8\%. Cost: \$0.06.
...
\medskip
\begin{itemize}
  \item Which 2 plants are missing?
