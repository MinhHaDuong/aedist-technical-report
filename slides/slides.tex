...
99\% of plants cite a corpus source.\\
98\% of citations trace to a corpus file.\\
\textbf{80\% end-to-end traceable} (citation $\to$ file $\to$ plant name; median, $n$=3).
...
% -------------------------------------------------------------------
\begin{frame}{Perspective: why would we need a knowledge graph?}
