...
% -------------------------------------------------------------------
\begin{frame}{\NumCensusModels{} modèles, 163 centrales~: le modèle seul ne suffit pas}
\begin{center}
\includegraphics[width=\textwidth,height=0.82\textheight,keepaspectratio]{inputs/generated/fig_census_direct.pdf}
\end{center}
{\small Passe unique, sans documentation. \textbf{Le choix du modèle ne résout pas le problème.}}
\end{frame}
