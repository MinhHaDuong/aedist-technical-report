...
\begin{frame}[plain]
\centering
\includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio]{../report/inputs/generated/fig_spider_exp1_claude_fr.pdf}
\end{frame}

% -------------------------------------------------------------------
\begin{frame}{Famille et taille comptent~; description des centrales~: point faible}
\centering\vspace{-0.4em}
% Crop the baked-in figure title (FR: "La source est le mode de défaillance
% universel") off the top, then enlarge into the freed space at the bottom.
\includegraphics[trim=0 0 0 42bp,clip,width=\textwidth,height=0.98\textheight,keepaspectratio]{../report/inputs/generated/fig_spider_exp1_families_fr.pdf}
\end{frame}
...
% -------------------------------------------------------------------
\begin{frame}{La méthode --- Condition harnais simple (bras 2 \& 4)}
...
\smallskip
{\small\textit{Harnais simple = orchestrateur (classifieur DeepSeek) + boucle + outil (LLM testé). «~Simple~» car les prompts sont fixes, non générés de manière adaptative.}}
...
\centering\vspace{-0.4em}
\includegraphics[width=\textwidth,keepaspectratio]{../report/inputs/generated/fig_exp2_coverage_certainty_fr.pdf}
\end{frame}
