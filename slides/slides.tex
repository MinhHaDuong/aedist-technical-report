...
% -------------------------------------------------------------------
\begin{frame}{The obvious approach (1/2): the table}
\begin{columns}[T]
...
\medskip
\textbf{You get:} a CSV table of 77 plants in 30 seconds, for \$0.02.
Names, fuels, capacities, provinces --- zero fabrication,
but only \textbf{47\%} of the 163 reference plants.

\medskip
With the right method (RAG + decomposition), a cheap model
recovers \textbf{163/163} plants. F1 = 98.8\%. Cost: \$0.06.
...
\medskip
The naive approach gives a plausible table.\\
The question is whether we can \textbf{trust} it ---\\
without cognitive surrender.
\end{columns}
\end{frame}

% -------------------------------------------------------------------
\begin{frame}{The obvious approach (2/2): the report}
\begin{columns}[T]
\column{0.52\textwidth}
\textbf{Ask Claude for the full deliverable:}
\begin{quote}\small\itshape
Write a technical report on Vietnam's thermal power fleet:
historico-prospective framing from PDP7 to PDP8,
asset-by-asset discussion of status and capacity,
annotated bibliography of primary sources,
and a synthetic table of all plants.
\end{quote}

\medskip
\textbf{You get:} 15 pages, coherent structure,
plausible chronology, real document names cited.
Delivered in 2 minutes for \$0.10.

\column{0.45\textwidth}
\textbf{What's wrong with it?}

\medskip
\begin{itemize}
  \item Citations look real but aren't verified
  \item Plant list is incomplete (same ${\sim}$77, nicely narrated)
  \item Capacity figures are approximate
  \item No way to distinguish fact from fabrication
  \item Updating it means regenerating everything
\end{itemize}

\medskip
The report \emph{reads} like research.\\
But it isn't --- it's a plausible remix of training data.

\medskip
\textbf{Our approach:} benchmark the \emph{methods},\\
...
\begin{itemize}
  ...
  \item Off-the-shelf pipeline recovers 99\% of an expert
        inventory for \$0.06
...
\begin{enumerate}
  \item The right methods recover 99\% of an expert
