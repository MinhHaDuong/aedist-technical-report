...
The paper addresses a problem the three aggregators do not: extracting a
...
marks Wikipedia's light-reviewed coverage of all 177 reference plants
(73\%, 130/177) ---
...
baseline. Row-level F1 against the 177-plant reference is
