...
*Figure 2. Direct-query performance across 14 models and 70 runs on the 177-plant Vietnam thermal reference. Each bar is one run; family-coloured segments to the right are correctly identified plants (TP), red segments to the left are unrecognized plants (FP). The dashed green line marks the 177-plant reference. Models are grouped on the vertical axis.*
